...
(for example IPC,...).
  ...
  s.homepage         = 'https://github.com/rsZWang/HarryWeb3.swift'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Harry Wang' => 'harry1106.mess@gmail.com' }
  s.source           = { :git => 'https://github.com/rsZWang/HarryWeb3.swift.git', :tag => s.version.to_s }
  ...
  s.swift_versions = '5.1.3', '5.1.2', '5.0', '5.1', '5.3', '5.7'
